...
//                "background-color": "red"
            ...
            // z-index handling
            var zIndex = /^\d+$/.test(self.css("z-index")) ? self.css("z-index") : 1990;
            // if z-index option is defined, use it instead of select element z-index
            if (settings.zIndex && /^\d+$/.test(settings.zIndex))
            	zIndex = settings.zIndex;
            overlay.css("z-index", (zIndex+2000).toString(10));
            input.css("z-index", (zIndex+2001).toString(10));
            selector.css("z-index", (zIndex+2002).toString(10));
