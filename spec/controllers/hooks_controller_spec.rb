...
describe HooksController do
  ...
  let(:subscription)  {FactoryGirl.create(:subscription, card_holder: "card_holder_test", firm: firm, plan: plan, name: "hookscontroller_test", email: "test2@test.no", paymill_card_token: "098f6bcd4621d373cade4e832627b4f6")}
