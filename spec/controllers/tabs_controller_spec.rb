...
describe TabsController do
  ...
  describe "milestones" do
	  ...
	  it "should get milestones" do
	  	get :milestones, id: project.id, class: "Project", :format => 'js'
	...
	describe "todos" do
	  ...
	  it "should get todos" do
	  	get :todos, id: project.id, class: "Project", :format => 'js'
	...
	describe "logs" do
	  ...
	  it "should get logs" do
	  	get :logs, id: project.id, class: "Project", :format => 'js'
	...
	describe "users" do
	 	...
	 	it "should get users" do
	  	project.users << @user
	  	get :users, id: project.id, class: "Project", :format => 'js'
	  	assigns(:members).should == [@user]
	  end
	end	
	describe "statistics" do
	  ...
	  it "should get statistics" do
	  	get :statistics, id: project.id, class: "Project", :format => 'js'
	  	assigns(:logs).should == [log]
	  end
	end	
	describe "statistics" do
	  ...
	  it "should get statistics" do
	  	project.users << @user
	  	get :spendings, id: project.id, class: "Project", :format => 'js'
	  	assigns(:logs).should == [log]
