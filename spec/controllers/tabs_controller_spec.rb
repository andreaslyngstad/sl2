...
describe TabsController do
  ...
  describe "milestones" do
	  ...
	  it "should get milestones" do
	  	get :tabs_milestones, id: project.id, class: "Project"
	...
	describe "todos" do
	  ...
	  it "should get todos" do
	  	get :tabs_todos, id: project.id, class: "Project"
	...
	describe "logs" do
	  ...
	  it "should get logs" do
	  	get :tabs_logs, id: project.id, class: "Project"
	...
	describe "users" do
	 	...
	 	it "should get users" do
	  	project.users << @user
	  	get :tabs_users, id: project.id, class: "Project"
	...
	describe "statistics" do
	  ...
	  it "should get statistics" do
	  	get :tabs_statistics, id: project.id, class: "Project"
	  	assigns(:logs).should == [log]
	  end
	end	
	describe "statistics" do
	  ...
	  it "should get statistics" do
	  	project.users << @user
	  	get :tabs_spendings, id: project.id, class: "Project"
	  	assigns(:logs).should == [log]
	  	assigns(:users).should == [@user]
	  end
	end	
