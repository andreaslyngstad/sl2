...
describe TodosController do 
  ...
  before :each do
    @todo = FactoryGirl.create(:todo, :firm => @user.firm, :project_id => @project.id, :user_id => @user.id)
  end
  ...
  describe 'DELETE destroy' do
    before :each do
      @todo = FactoryGirl.create(:todo, :firm_id => @user.firm.id, :project_id => @project.id, :user_id => @user.id)
    end
