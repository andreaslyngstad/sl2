...
describe "GET #show" do
  ...
  context "valid attributes" do
    it "located the requested @blog" do
      put :update, id: @blog, blog: FactoryGirl.attributes_for(:blog)
      assigns(:blog).should eq(@blog)      
    end
  
    it "changes @blog's attributes" do
      put :update, id: @blog, blog: FactoryGirl.attributes_for(:blog, title: "something else")
       @blog.reload
