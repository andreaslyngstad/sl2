...
describe "Get firms" do
  ...
  it "GET index" do
  	guides_category = FactoryGirl.create(:guides_category)
  	get :index
...
describe "GET #show" do
  ...
  describe "POST create" do
    context "with valid attributes" do
      it "creates a new guides_category" do
        expect{
          post :create, guides_category: FactoryGirl.attributes_for(:guides_category)
  ...
  context "valid attributes" do
    it "located the requested @guides_category" do
      put :update, id: @guides_category, guides_category: FactoryGirl.attributes_for(:guides_category)
      assigns(:guides_category).should eq(@guides_category)      
    end
  
    it "changes @guides_category's attributes" do
      put :update, id: @guides_category, guides_category: FactoryGirl.attributes_for(:guides_category, title: "something else")
